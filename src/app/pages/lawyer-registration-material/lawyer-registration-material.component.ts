...
@Component({
  selector: 'app-lawyer-registration-material',
  templateUrl: './lawyer-registration-material.component.html',
  styleUrls: ['./lawyer-registration-material.component.css'],
})
export class LawyerRegistrationMaterialComponent implements OnInit {
  userForm!: FormGroup;
  years: number[] = [];
